...
clf = RandomForestClassifier(max_features = "sqrt", bootstrap= True, n_estimators = 30)
...
transformed_X = pca.fit_transform(mnist_X)
...
train_X = transformed_X[0:60000,]
train_y = mnist_y[0:60000,].astype(int)

test_X = transformed_X[60000:70000,]
